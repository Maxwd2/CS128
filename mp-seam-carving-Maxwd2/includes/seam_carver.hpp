...
private:
   ...
   */
  // Done
  int GetHorizontalEnergy(int static_row, int col) const;
  int GetVerticalEnergy(int row, int static_col) const;

  int* VerticalSeamFiller(int**& seams, int idx) const;
  int* HorizontalSeamFiller(int**& seams, int idx) const;
};
